...
### Teaching Technique -  Iterative Designing
...
### Teaching Technique - Worked Examples and Design Patterns as Educational Tools

Design patterns are solutions to problems or common scenarios in design domains. Design patterns emerged from architecture but are commonly used for computing students at higher education to teach object oriented computing. They are also relevant and useful for all levels of coders. Design patterns are rooted in real-life incidences of problems that are often solved in a particular way. They are concrete example of coding principles in context. Design patterns can help the development of coding communities if more experiences coders take the time to document the patterns they use in an accessible way for novice coders.
...
### Teaching Technique - Use-Modify-Create
...
### Case Study - The Online Scratch Community
