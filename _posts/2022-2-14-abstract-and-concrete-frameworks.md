...
Computational Thinking model by Resnick and Brennan - Diagram created by Mick Chesterman - This could be substituted with a table.
...
REFINE
The tension between abstractable and transferrable knowledge and more bound to context concrete knowledge exising both in definitions of CT and in approaches to teaching.
Teachers must steer a course between the two. 
In the next section we turn to teaching tactions.
