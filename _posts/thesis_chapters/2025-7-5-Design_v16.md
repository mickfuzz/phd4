...
ADD A QUICK SUMMARY OF PROCESS. LINK TO THIS IMAGE.
...
**Results**
Turing to a summary of the results of the process, the use of a design narrative processes informed by DBR practice [@hoadley_creating_2002] has been employed to share not only the detail of the end results but also the emerging tensions that drove them and replicable approach. With that aim in mind the following list shares links to currently online and reusable resources [^44].
