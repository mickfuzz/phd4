...
This chapter has exposed the tensions that developed in the activity systems and subsequent evolution the tools used include code authoring environment, supporting resources of printed and digital format. This section begins to analyse these tensions, in particular those related to authenticity of tool use in relation to concepts of participant agency using the conceptual lens of dual stimulation. On research into the use of wikis by students Lund and Ramussen [-@lund_right_2008-1] caution against mismatches between the first and second stimulus. Their interpretations of double stimulation situates a project task or objective as the first stimulus, and tools used to the as secondary stimuli. They also outline the importance of awareness of the likelihood of multiple stimuli in modern technical working environments. While Sannino's [@sannino_principle_2015] work on the volitional aspect of the process of double stimulation cautions 'double stimulation cannot be subsumed to the general idea of mediation by symbolic tools' [-@sannino_principle_2015, p.2], it shares the a perspective that there is value in exploring the process to shed light on participants development of agency in professional and educational settings [@sannino_formative_2016].

Traditional, printed, instruction-based software manuals are in decline partly due online documentation but also due to the increased intuitive nature of their design [@pogue_user_2017]. This decreased need for secondary documentation
...
The previous section can be viewed from perspective of designing coding tools to increase agency in practical terms by providing affordances to achieve common design aims and thought removing barriers or aspects of negative liberty [@matusov_mapping_2016, p. 433]. In addition, I propose that the process of using more authentic toolsets has the potential for engendering transformative agency [@engestrom2006development; @haapasaari_emergence_2016; @sannino_formative_2016].

The distributed nature of the toolset used helped build authentic digital literacy skills. Participants became adapt at thus transforming chains of actions into a fluid operation. Learners who had mastered the skills were asked by others for help, becoming domain experts, and thus providing additional affordances in the learning community.
...
| Unfamiliarity with group project management  | Tensions arising through group miscommunication in P1     |  Avoiding large groups from P2 onwards, adn starting with a half-baked game template which individuals or pair used as a base. |   
...
[^12]: https://en.flossmanuals.net/phaser-game-making-in-glitch/_full/
