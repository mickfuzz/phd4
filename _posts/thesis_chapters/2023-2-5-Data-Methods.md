...
-   [Scenarios - drama processes](#scenarios---drama-processes)
    ...
    -   [Discussion of the process
        drama](#discussion-of-the-process-drama-1)
-   [The impact of tools, documentation and emerging technical
    processes - MERGE THIS WITH DESIGN PROCESSES
    BELOW](#the-impact-of-tools-documentation-and-emerging-technical-processes---merge-this-with-design-processes-below)
    ...
    -   [Starting Tools and processes](#starting-tools-and-processes)
        ...
        -   [Guided Code Patching
            Process](#guided-code-patching-process)
        -   [Visual and Audio asset
            creation](#visual-and-audio-asset-creation)
        -   [Impact of play-testing](#impact-of-play-testing)
        -   [Discussion on tools/processes when designing for agency /
            participation in new coding
            community](#discussion-on-toolsprocesses-when-designing-for-agency-participation-in-new-coding-community)
    -   [Emerging, flexible design practices /
        processes](#emerging-flexible-design-practices-processes)
