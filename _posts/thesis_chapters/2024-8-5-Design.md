...
The advantages of designing primary tools, those used to directly achieve the task rather than secondary tools (e.g  documentation and support processes), is that the guidance is built into the production process in a way which aligns with microworld concepts, thus reducing dependancy on facilitator instruction. Affordances supporting the Modify stage of UMC.
...
ILLUSTRATE THIS WITH A TRIANGLE
