...
The following vignette is used to introduce the activity system at both community and individual levels, and to illustrate the types of tensions that shaped later design responses. A fuller vignette is included as Appendix.5.toby. From a 3GAT perspective, this activity can be understood across two nested levels. At the community level the over-arching object of the activity in broad terms as collectively making a game to share. To illustrate this goal the following photograph of P3 end showcase show learners share their games in the foyer of the university building in which the activity took place.
