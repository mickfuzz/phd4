...
In the initial stages some families struggled to reconcile the obstacles presented but
...
The template game was hosted on the code playgroud
...
I experimented with different categories and themes to contains the emerging game elements. I also explored the concept of mapping the different challenges by difficulty on a map via structuring via concentric rings.
...
This chosen structure mirrored and potentially reinforces  the process of analysing game elements. Done via games at the start of sessions.

This is relevant to RQ1 as a potential tool for facilitators to jump start

While the process of games analysis has limited research for novice game makers, it is not the the field of learning text coding. Similarly this outcome of theming the patterns by function and  and difficulty to help build community game making activity and knowledge aligns with the work by Holopainen and colleagues on the use of pattern collections to help structure game making for adults [@holopainen2007teaching]. While researchers ahve undertaken similar work
