...
It is useful to to disambiguate key terms at this stage .

Conflicts / contradictioins  - stop progress - and involve barriers.



On a smaller scale, design tensions exist. These do not block progress completely but may disrupt some activities.

Also conbinations of tensions may create longer lasting and more serious conflicts if not resolved in some way.

IN this chapter tensions are observed and potential tension  imagined by the facilitator. And in response interventions or new tools to help increase leaner agency either by offering new tools or removing barriers in process.

It important here to examine the difference between  instrumental agency, and the work of learning designers to remove  barriers, vs the potential for learners to address and overcome them is relevant here.
...
### Participant Conflicts / Obstacles
...
**Facilitator / Participant - Projected Barrier -  Learners may not find coding a project a motivating project if it is only a private activity with no authentic audience.**
...
**Drop? Restricted community - e.g. why not scratch?**
