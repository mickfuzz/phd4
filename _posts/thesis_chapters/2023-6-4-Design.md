...
Thus in the next iteration, rather than the larger groups, smaller groups, allowing some children to work by themselves and others with parents. Avoiding large group framentation and encouraging freedom of participation vs benefiting from parental involvement.
...
**LINK - Overcoming lack of software feedback - MOVE TO NEXT SECTION OR KEEP HERE AS A LINK?**
...
The a game template served a similar purpose. This is explored in the next section.
...
In the initial stages the families were not able to reconcile the obstacles
...
In line with this research, I posited that using a starting template would to increase speed and consistency of feedback from learner input, to reduce coding syntax knowledge needed in starting from scratch, and thus reduce learner anxiety for novices. This approach responds to the feedback from the participant that more hands on time with tools would have really helped them.

The impact of this starting template is explored in the following chapter.
...
This process was initially confusing for participants. Thus while these resources were developed in response to one conflict they introduced new tensions. Specifically navigation of the resources and how they fitted together.

**Use of a collection of game design patterns**

I decided to create a web page to house this collection of code examples, the starting template and a link to the online book of step-by-step resources. 



EDIT THIS DOWN AND FIND THE KEY THEME HERE - MERGE WITH NEXT SECTION IF POSSIBLE.
...
#### Structuring the pattern collection

This section goes into detail of different themes the game pattern collection. This is relevant to RQ1 as this structuring mirrors and has the potentials to reinforce the process of analysing game elements. Done via games at the start of sessions.
...
While not driven by other research at this stage, in retrospect, the goals of theming the patterns by function and difficulty align with the work by Holopainen and colleagues on the use of pattern collections to help structure game making [@holopainen2007teaching].  
...
**Limits to the learning dimensions map**
