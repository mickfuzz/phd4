...
The next chapter explores responses to this aspect in more detail.
Link
...
Other interventions were called for directly by parents. Some were slightly unexpected. in particular the call for tutorials.  Despite the general agreement that taught input in class time was not welcome, support resources that did teach coding materials would be welcomed by some families.
