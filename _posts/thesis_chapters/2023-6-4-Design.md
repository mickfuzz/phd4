...
- my interest in informal learning - recap rogoff and similar - and - issues of designing for informal settings
- design based experiments - some factors - transistion from previous chapter
...
- exposes tensions in this domain from interviews with peer practitioners.
-  charts the evolution of the learning design
- It draws on immediate analysis of participants reactions and contributions from journal notes,
- participant interviews and analysis of changes in the learning resources created.

**Formative Interventions / DBR**
...
<!-- NOTE - Recap last chapter - move most /any context there.  -->

Exposing tensions in activity systems is key to the process of design.
...
CHECK BACK TO METHODOLOGY TO EXPLAIN THIS NESTED APPROACH
These descriptions mirror the work of AT researchers who conceptualise scope of activity as concentric circles from Broffennbrenner with "larger" scopes of cultural and societal goals and smaller, narrower, lower scopes of more personal activity.
As previously explored this mirrors the Activity, Action and Operation hierarchy. 

On a wider scale, the overarching objectives of learning via engaging with the programme (parents), being part of a fun club (children) and conducting research (researcher), the system scopes include:
...
- Narrow objectives: creating, changing and transporting game assets or changing code constructs to enact or change game elements
...
#### Levels of Abstraction om this design (perhaps drop?)
**moved from previous chapter_**
...
Phase two comprised one off sessions with adaptions based on my observations, and feedback from participants of phase one.  
...
- more or work out right format -
  THESE ARE EMERGING CONFLICTS - MOVE LATER.
...
It is useful to return to the exploration of key terms of the theoretical framework at this stage.

Conflicts / contradictions  - stop progress - and involve barriers.

On a smaller scale, design tensions exist. These do not block progress completely but may disrupt some activities.

However combinations of tensions can compound to create longer lasting and more serious conflicts if not resolved.
...
In this chapter I examine both tension and initial conflicts that occur in the first phase of of the learning design.

It important to re-examine the difference between types of agency explored in the theoretical framework.
...
### Facilitator Design Tensions

Proactive choices.
Lack user oriented data. Projected experience / intuitive.  
And drawn from motivations / objectives of researcher.


####  FACILITATOR - Authenticity of coding environment  
...
#### Facilitator / Participant - Projected Barrier / (tension) - Authenticity of Audience
...
#### Drop? Not important enough for agency
...
#### One - Identity hardcore coding & disfunctional group work - P1
...
#### One - Two transition - freeing up collaboration patterns

**Encouraging peer learning vs social restrictions (One and two )**

Asking on email forum not realistic -
...
#### TWO - Participant experience of Contradiction - Conflict - not enough support available

**Conflict / Barrier - Learners difficulties  writing valid code**
...
**Two - Documentation / Support Tensions**
 <!-- NOTE -
