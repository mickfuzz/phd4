...
NOTE - While the below are nested - some higher ones may be competing
...
**Narrow Objective - Implementing discrete code and desing structures**
...
NOTE - YES - BUT ALSO A DIFFERENT ACTIVITY SYSTEM - FIND LITERATURE TO EXPLAIN THIS.

Using the terminology of Activity Theory, each one of these stages can be viewed as a separate operation in the process of completing an action.
