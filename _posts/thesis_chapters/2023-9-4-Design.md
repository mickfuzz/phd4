...
My experience of the process of adapting the learning design to the needs of more formal settings supports existing research in this area. The following table aims to summarise the alignment of the potential of this work with other research.
...
## 3. Participant conflict due to lack of access and familiarity to tools and processes

**Nature of conflict - unfamiliarity with tools- complexity of processes leading to frustration**

This conflict, which surfaced in P1, was a conflation of various tension which stemmed from lack familiarity with coding and game making tools and practices. While, such tensions stemming from gaps in knowledge and practice are commonly addressed in formal learning environments through instruction, the informal nature of this learning setting made such approaches unappealing. I was keen to align with the motivational potential of hands-on (learning by experience) approaches to STEM education [@holstermann_hands-activities_2010].
...
CLARIFY AND AND SIGNPOST TO WHY NOT SCRATCH
...
### Addressing complexity of code environment through the use of a code playground

Code playgrounds, as described in chapter two, are an online environment used to test, share or invite help from online users. Using a code playground removed the process of setting up a server for web development, and the delay and complexity of transferring files to the server.

While the game code project consisted of several files of javascript, HTML and CSS, learners were shielded from the complexity of understanding how they were interlinked.
...
CHANGE THIS TO A LANDSCAPE CARD?
