...
NOTE -FIND THE JSCARD IN GOOGLE DRIVE DOWNLOAD IT TO WORD AT WORK AND OPEN IT. USE VELOCITY
...
An inspirational aspect of _lifting the lid_ on previously unknown technology was reflected in a conversation among adult participants. They communicated a sense of awe of how much effort and coding must be involved in a professional game based on the relative complexity of the code of their simple game.  
...
The process of creating bespoke documentation in the form of code snippets and step by step tutorials can be seen as occupying a pragmatic position on the scale of authenticity. While both were carefully aligned to the specific code template in a way that authentic developer focused documentation would not be, the process still developed skills used in professional settings.

An interesting design tension here is that of which kind of documentation to prioritise. From the collection of GDP, I first linked directly to code snippets. When step by step tutorials were complete I link to those and at the start of each chapter included a link to the code snippets. In retrospect, my interpretation is that I prioritised the traditional form of instruction over different, bricolage-like developer practices. I propose it would be best to rectify this in future iterations of the design giving each equal weight.  
