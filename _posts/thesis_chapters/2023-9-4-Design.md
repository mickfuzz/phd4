...
### Outline of Game Making Tools used in this vignette
...
The smaller activities used to kick start other game makers were an accelerated version of the full process, proposing modification instead of new code structures.

The implementation of discreet but potentially shared game elements became a shared pattern of activity. Mutual work to produce resources, testing techniques and practices to share and evaluate these shared elements became a primary focus of work. This matches conceptions of germ cell concepts in the previous chapter from Engestrom.
...
To avoid the dangers of the vague use of the terms tensions and contractions [@karanasios_exploring_2017], this chapter will aim to be more descriptive.  

While guided by teh concept of analyising manifestations of systemic contracditions, [cakir_contradictions_2022; engestrom_discursive_2011] this study does not use that detailed framework
A wider lens is used instead, that of Rogoff's 3 foci helps to situate realms of contradictions.
...
In the following sections of this chapter I focus on such which relate directly to the research questions and which help inform the findings of later chapters. In particular I draw out more visible conflicts which threaten more serious disruption of activities.
