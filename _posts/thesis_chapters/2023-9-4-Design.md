...
Although, help was available via in-line text code comments, I noted that to notice and read these comments required a degree of proficiency or code familiarity that not all participants had. In early trial, I had relied on participant experimentation, direct instruction to individuals / pairs (via pointing), and resultant peer learning happening. I relied on small groups initially.  
