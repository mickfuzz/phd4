...
In most of this chapter focus on the tools and authenticity in relation to other tools.
...
**Key questions / motivations in creating a new learning community - MOVE?**
...
A summary (table or text) of the barriers exposed in interviews and in journal observations and in feedback from participants. Perhaps linking to appendix.
...
A key focus of this chapter has been relatively micro - barriers to computer coding and use of particular software - drawing on and aligning with the HCI literature and existing work which exploses problems of learning programming syntax.

However, while essential to the progress of the participants, this is not the main focus of the study.

NOTE - Change the following to link / signpost to other chapter x 2 .
And suggestion is to sway 5 and 6 - so putting game design patterns first.
