...
In this example, Toby could have used an additional resource, in the form of a online and printed tutorials provides more descriptive, step-by-step guidance. Instead he builds his competence in the process of comparing the own code to the code example to work out what code is new and relevant to the desired behaviour. Others in the group relied on the detailed written instructions. Others still relied only on direct verbal help from myself or other participants and for those participants the help of others like Toby to help them progress was most valuable.
...
### Exploring game design patterns as germ cell of activity and unit of analysis

For this research, I have chosen to privilege the implementation of each pattern as a sub-activity system. The justification for this mirrors choices by other researchers who see the utility in a more granular exploration of the processes at work in a complex process [@barab_using_2002].
...
The concept of germ cell is relevant here as the same germ of an idea yeilded varied forms of support.
