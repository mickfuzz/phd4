...
While in P2 and P3 I reduced the the number of tools suggested to create graphical assets, there was still the process of transfer from one to the other creating a porous learning environment.
