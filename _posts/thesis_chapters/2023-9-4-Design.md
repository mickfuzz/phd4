...
The small, quick start activities used to kick start activity  game makers were an evolution from  the full process of adding a game pattner. The proposed code modification instead of new code structures accerated the process.
