...
In this design the tools set is distinct from tools like

Scratch which are self-contained to a large degree  

In many thus bears greater similarity with the Microworld concepts.
