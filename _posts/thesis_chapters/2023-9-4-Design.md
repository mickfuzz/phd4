...
|  Mick(f): Another is to make your enemies move around the screen to make it a bit harder. I know you guys have done that.  | Mick moves a pointed hand to indicate an enemy moving on the screen and then ponts to Clive and Pearl to indicate you guys.   |  |   |   |
|   |   |   |   |   |
...
#### Analysis in relation to existing design heuristics of toolsets
