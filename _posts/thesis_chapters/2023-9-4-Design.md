...
-   [3. Participant conflict due to lack of access to
    ...
    -   [Observations on the impact of the half-baked game
        template](#observations-on-the-impact-of-the-half-baked-game-template)
...
## 3. Participant conflict due to lack of access to tools
...
### Tensions between authenticity in choice of toolset and user progress

Dimensions of authenticity are explored in the literature review. NOTE INCLUDE SUMMARY

  - similar to workplace
  - has a real purpose for Participants
  - can be showcased in public for an external audience

While the digital focus of the activity allowed for a high level of authenticity in the sense of aligning with professional practice, due to the potentially prohibitive complexity of tools, I took care to screen participants from processes and tools that were unrealistic for novices to use.
...
### Impact of use of code playground
