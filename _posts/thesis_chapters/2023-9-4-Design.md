...
![learning islands]({{ site.baseurl }}/_posts/thesis_chapters/Pictures/navigational_paper_map.png)
...
In addition scratch also expanded the value of the community for feedback and for motivational factors. The Scratch online

While, there is a potential to
