...
Despite building familarity with code, at this stage  the process of adding elements still needed significant support.

In a redesign of the startign code template at the end of P1, I added the following design techniques to the template to make modifying the game easier.


#### Addressing barriers with template
...
The impact of this starting template in the P2 and 3 and P4 sessions is explored later.
