...
I chose to not use Scratch, partly as it was well reseached and partly to prioritise authenticity of tool set despite the removal of certain technical barriers offered by such a self-contained tools set.  
...
<!-- I now explore 2/3 key obstacles and how they were addressed. -->

Creation and migration of graphical and audio assets.

In Scatch there are tabs which host simplified graphical and audio studios. Design decisions priorise ease of use and the ability to record audio right into the program.

In P1, I used a variety of graphical and audio tools including Scratch to create backgrounds, Piskel to create pixel graphics, Audacity, Sonic Pi for background music, Bxr online for sound effects.

Participants would then have to save assets in a compatible format and upload them to the code playground, and link the file using a line of code.

The self-contained of scratch has this reduces possibility for compounding errors caused by mirgration of data.

The difference in friction to adding assets is significant and the possibilities for it to go wrong also great. Hoewver, to counter this, I observered a palpable  a sense of achievement of doing this in code.
...
The process of getting started in P1 took too long and from a motivation of an responsive lacked a guiding structure. Introducing a starting template helped participants build from this base and build familiarity with the code. However, the process of adding elements still needed significant support and I decided to work on the following elements to make the process of design by modification easier.


#### Addressing barriers with template

The creation of a template and mini challenges helped address the challenge
