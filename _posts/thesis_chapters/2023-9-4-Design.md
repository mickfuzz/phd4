...
Despite minimal evidence due to afactor later explored, there were some observations.
...
#### Comparing to Scratch and Microworlds
...
In this design the tools set is distinct from tools like Scratch, Logo in that while those tools were designed to be  self-contained, the use of a JZ library in a web coding environment is more open-ended.

The clear software-based self-containment has clear advantages of control and reducing possibility for compounding errors.
...
While these heuristics provide a useful tool for designers and practitioners supporting creative coding activities there is less intrinsic guidance to help seed community practices.

**Community design and guiding community behaviours :**

In addition, scratch also expanded the value of the community for feedback and for motivational factors. Research shows the value of the Scratch online community has the potential to x, y and z.
...
This was picked up on by the community as they viewed each others assets and playtested games.

While, there is a potential to engage with wider  community tools like remix, online sharing, and to invite  are part of the glitch code playground community, I did not ask particant to focus their attention in this direction.
