...
**Comparing my design to Scratch and Microworlds's Design principles / heuristics:**
...
Existing research on computing projects in the work of Papert [-@papert_mindstorms_1980] on Mircoworlds and subsequent research on programming tools in the constructionist tradition were explored in brief in the literature review. [@kafai_constructionism_1996-1; @kafai_mindstorms_2014].
...
In scratch, the ability to reduce syntax errors through block coding was adopted. Reducing the complexity of coding environment in one of several guidelines in the process of designing toolsets to support creative coding [@resnick_reflections_2005] [@resnick_design_2005]. Recap of constructionist heuristics   low-thresholds, wide-walls, high-ceiling
...
**Authentic tool use and forms of agency**
