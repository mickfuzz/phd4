...
As explored in the introduction, the community plane of activity corresponds to AT diagram 5.x / 4.x - repeated below.


Rogoff [] frames activity at this level as that examining community norms and repertoires, a concept also explored in Cole's work in the 5D as an emerging idioculture [].

The following section explore how this happened in relation to the use of GDPs in varied ways.  x,y,z
...
Returning to the complexity of Suzanna and Olivia's interaction which involves negotiation over the imagined experience of others involves the use of GDPs concepts. These game design patterns (GDPs) focused on gameplay rather than code structure focus on recognisable behaviour.
...
In interpreting data there were other examples of pair partners and peers either commenting oWhile other community interactions existed (introductions, warm up games), playtesting a medium for an idioculture to emerge became a significant part of the pedagogy. n or suggesting to others that they should imagining others user experience to suggest game design alterations.
...
Addressing the apsect of patterns aesthetics, in Vignette 5 Molly and Nadine showing identification with graphical making process and the process of bringing it the game.  
Beyond their internal family interaction, they share this artistic flair or attention to detail into the emerging learning community.

<!-- CAN THIS BE LINKED TO FORMING IDENTITY WITHIN THE COMMUNITY VIA A SPECIALISM? THERE IS DATA FROM AN INTERVIEW TO SUPPORT THIS. -->
