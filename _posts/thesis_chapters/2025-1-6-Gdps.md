...
The above example from Vignette  details Madiha getting help in exporting graphical files to be imported into the game code project is example of GDPs taking a role in the development of technical processes. Here the parent needs to learn or at least to draw on peer knowledge to complete the implementation of her chosen pattern. Similarly later, Madiha is helped in the use of the cropping tool by a peer child Ed(c)
