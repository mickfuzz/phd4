...
### Addressing GDPs in relation to processes of mediation and incorporation in repertoires of practice
...
In this chapter the last section examining activity on cultural plane exposed, elements of transfer between different activity systems, supporting Gutiérrez's [@gutierrez_developing_2008] perspective  regarding the importance of transcending borders and linguistic practices between sites of learning. In these examples, the process of playtesting often served as a facilitative medium for a shared idioculture to emerge and, as such, became a significant part of the pedagogy of the learning design.
DRAW ON A COLE idioculture SOURCE.
...
To support the development of similar emerging practices which drew on FoK, I introduced, social missions, drama frame and concepts of maker types.
...
I began to recognise the process of non-technical and non-GDP elements of the learning process being incorporated in emerging repertoires. This is especially noticeable in the above sections on use of FoK and division of labour.
OTHER EXAMPLES
...
WHERE TO PUT THIS EXAMPLE? HERE OR BEFORE? AND IF HERE DEVELOP ANALYSIS IN LINE WITH THEORY?
...
Similar to the way tools were modified to provide new affordances for participants, in P3 I began to encourage these process by introduced several activities to augment the affordances of the playtesting medium.
...
In retrospect, many of the social missions explored above encouraged activity outside of strictly productive design activities. For example the lively discussion about game playing in response to the mission to _find out the favourite games of 3 other people_.

**Discussion on Player types and side-missions**

<!-- DATA REQUIRED FROM VIDEO!? -->

The process of exploring identity in this way surfaced the cheekiness of some young people and the pleasure they took in demonstrating their playful mischievousness. I began to make journal notes on this subject and talk to other games study practitioners. I began to ask the question can the surfacing maker types (as per player types) encourage awareness and celebrate the emerging practices that the community was producing.

Recalling the barriers to participation explored in Chapter 2, my rationale for this process was to promote awareness of pluralistic programming process [@papert_epistemological_1990].
...
AND LINGUISTIC DEVELOPMENT? LATER?



**Limits of maker types**
...
Narrative, something interesting started to develop a flexible, flow based practice....
Coming back to my motivations as a facilitator and links in the literature of CoL and Papert's Samba school.

Intro; here I will cover observations of the characteristics of these emerging design practices, twinned design affordances  and links them with existing  conceptualisation within the literature. Including:

  - flexibility in design stage, jumping arbout in design cycles, rapidly responding to Feedback
  - via division of labour, and making styles via incorporation of funds of knowledge, home interests
...
This section therefore describes a set of evolving and flexible design practices, partly as a counterpoint to design thinking stages.
...
The examples of this chapter show the importance of GDPS as a lingua franca, as a mediational strategy to facilitate these kinds of flexible responsive collaboration.
