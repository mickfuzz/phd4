...
Whereas the motivation of LOA is that is is useful for learners to know at what level of abstraction they are operating, I propose that a stronger utility is that facilitators are aware of the level of abstraction. Different purposes and contexts of learning may require different interpretations, for example greater awareness of abstract concepts for reasons of assessment.
