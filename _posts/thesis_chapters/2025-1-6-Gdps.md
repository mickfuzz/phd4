...
Thus observations from video data in this study support existing research on the use of funds of knowledge and interest in digital projects as motivating factors and as a way to overcome barriers to alien cultures [@gutierrez_learning_2019-1]. I also propose that MDA framework can be useful to facilitators to plan for choice in a way aligned with existing inclusive pedagogy, a point I explore in more detail in the discussion section. 
