...
Pandoc for this chapter.

pandoc  -s -o   ../drafts/2023-2-chatgptlitreview.md.odt -V lang=en-GB --lua-filter=../../../pandoctest/zotero.lua --filter=pandoc-citeproc  2023-2-12-LitGPTResults.md

pandoc   --template=../../../pandoctest/toc-template.txt --toc -t html  2023-2-12-LitGPTResults.md | pandoc -f html -t markdown > tocs/chatgtp_toc.md  -->
