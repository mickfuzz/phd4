...
While research on the use of design patterns to support K12 programming education is scare. Existing work has focused main on transfer to science simulation [@repenning_scalable_2015] or analysis and assessment of code complexity [@werner_children_2014; @bienkowski2015assessment].

Given the framing of design patterns as intermediate-level concept between concrete implementation and abstract theoretical constructs, I now turn to explore the potential to contribute to existing research in in this field: specifically I explore the research findings of the last chapter in relation to computational thinking, levels of abstraction (LOA), and epistemological pluralism.
