...
In this study , the game features are concrete 
The concept of design patterns is abstract

Around this abstract different behaviour patterns form
And the concerpt can be embodied on design artefacts
And can be observed an designed for

The process can be transferred to other design projects
