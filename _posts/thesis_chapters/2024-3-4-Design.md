...
In line with key techniques of third generation activity theory (3GAT), this chapter addresses the evolution of the key pedagogical features of the tools of learning design used in my research process using analysis of elements of nested activity systems and emerging tensions in learning design. This chapter contains a high level of detail on the technical elements of the learning design to both both helps situate the findings of the next chapter and to allow the design to be by other practitioners and researchers in this area.
...
While the broad aim of making a game to share is tacitly agreed through participation, there are also diverse motivations stemming from environmental factors in the interrelated actors in this activity which bleed into the tensions which emerge at this level.



*Illustrative vignette one participants activity indicating general activity of participants*

In the vignette and surrounding data, Toby pays close attention to the challenge and variety of the game playing experience for his projected audience of players. In the vignette above, I draw the participants attention to the showcasing of their games to an external audience. Toby begins the session playing his own game. During the course of this session he invites many other group members to play his game. He initiates and responds to conversations around the difficultly of the game he has designed.

EDIT WITH ABOVE
The purpose of this vignette is to illustrate some of the key features of the overall game making activity in context. The following vignette, consisting of extracts of participant activity over tweood bunch of phones to be worked on too in our devices
cupboard if anyone fancies giving some a go today. I'll be there from
11.30 todaynty minutes of a session in P2 (see below), shows activity happening at different scopes of activity. The participant, a child Toby, has been working independently on the design of a platform game for the first fifteen minutes of the session. Some specialist terms are used in the vignette which are explained in more detail in this chapter and in the glossary.

The vignette is included as an appendix of this chapter as Appendix 4.a -
...
Within the activity system of making a game, in analsis of video data and evolution of course resources from P2 onwards, I identified activity happening at an individual or pair work which emerged with disctinctive characteristics.
...
While access to HTML and CSS files of the base project was available in the left menu as show in  by default participants would see only the JavaScript file names game.js (See Figure 4.x)
