...
The experience of the family with withdrew aligns with research addressing barriers concerning identity and technology-driven practices [@kafai_constructionist_2015-1]. The story is an example of a conflict composed of accumulating tensions which resulting alienation from the group coding environment and associated peer working dynamics.

My journal notes detailed an evolution of attempts to try to build into the program, activities which help build the participants sense of their own identities of game makers or more generally digital designers. These are detailed in summary form in this section and in more depth in chapter six.



Some barriers stemming from alienation from participant group workin
g processes were resolved partly by freeing up some patterns of collaboration and interaction and removing others.
