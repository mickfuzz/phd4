...
#### Rationale of use of drama processes

The starter game described below led me to connect the work with drama process work to develop ways to encourage diverse and playful approaches to making. The following sections describe the process.
...
EXPLAIN HOW.  
Side missions or side quests are also use#### Rationale of use of drama processes

The game above led me to connect the work with drama process work to develop ways to encourage diverse and playful approaches to making. The following sections describe the process. d in open world games are used in part to appeal to different kinds of players [@bartle_hearts_nodate].
