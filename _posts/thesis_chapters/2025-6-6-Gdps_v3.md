...
I provided participants with a choice of supporting documentation in the form of both step-by-step instructions and code snippets. While both forms of documentation following the structure of close coupling between impact and that is core to the use of design patterns in computing education [@gamma], this decision resulted in varied patterns of use. In the Vignette 1 extract above, Toby uses the graphical menu of patterns as a starting point to help him to choose, find and implement a GDP feature using supporting code snippets directly. Thus in contrast to Vignette 2, he does not access the step by step instructions.  

<!-- Later Toby is able to assist others in adding GDPs to their games [^rc2]. POTENTIALLY DROP THIS / MOVE -->
**Commentary**
In my use of gamePLAY design patterns the coupling is more tangible still for participant experience. the impact in the game is very relatable. LINK TO CH. 7 and LATER FOK
This extends current research in this area. HOW ? SUMMARY 
...
The use of GDPs as a lingua franca as proposed by Erickson and colleagues [-@erickson_lingua_2000; -@eriksson_using_2019]
