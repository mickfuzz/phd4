...
- Learning design
- Technical appendices - links to online material.
...
In feedback the parent shared they didn't want to bother other families with problems via the email list, and also noted the hesitancy caused by parental involvement compared to the kids ability to jump in and learn from each other less self-consciously.
...
**Anastasia's input into P1 evaluation interview**

Anastasia  shared reflections on the issues of family and home education dynamics, suggesting that parents may get in the way of young people's ability to move into other's spaces to learn things, and that parental helping roles may therefore be a hindrance.
...
### Appendix C.4 - Use of visual prototyping
...
### Appendix C.5 -  Case study with Maggie's family

There are some relevant reflections in interview data. THIS SECTION TO COME.
...
**PREVIOUS Description of types of activities involved in game making and the tools used to do them**
...
#### Appendix D.1.x - Links to online resources created as part of Phases 1-5
...
Github: https://github.com/jamm-labs/grid-game
...
THESE WILL BE INCLUDED AS LINKS TO ONLINE RESOURCES

Summary of structure follows.


- [Appendix E - Technical appendices](#appendix-e---technical-appendices)
    -   [Appendix e.x - Additional narrative of tool evolution Phases 1-5(#appendix)
        -   [E.x - Overview of Code Playground features and
            characteristics](#e.x---overview-of-code-playground-features-and-characteristics)
        -   [Appendix E.x - Design decisions in the technical decisions
            of the template design in
            P2](#appendix-e.x---design-decisions-in-the-technical-decisions-of-the-template-design-in-p2)
            -   [Code variables and
            ...
            -   [Template structure and asset placement - Add in Chapter
                tutorial example extract here
                too](#template-structure-and-asset-placement---add-in-chapter-tutorial-example-extract-here-too)
        -   [Appendix.E.x - Developing Digital Literacy
            skills](#appendix.e.x---developing-digital-literacy-skills)
        -   [Appendix.E.2 - On patching & and
            debugging](#appendix.e.2---on-patching-and-debugging)
            -   [Transcript of interaction explaining code
                patching](#transcript-of-interaction-explaining-code-patching)
            -   [Appendix E.x - debugging GDPs used to nurture tactical
                responses to coding
                errors](#appendix-e.x---debugging-gdps-used-to-nurture-tactical-responses-to-coding-errors)
