...
Extending Basawapatna and colleagues [-[@basawapatna_zones_2013]] approach to support proximal flow (see Chapter 2) via just in time documentation aligned with participants goal to support participant engagement, adding greater specificity and choice over which game patterns participants implement. This adaptation help greater alignment with research on the interdependence of flow experience and possibilities for social identity development [@mao_optimal_2016].
