...
This discussion begins to address the challenge of communicating the diverse mediational strategies beyond the list in the table as a more accessible and practical conceptual model. 

I then turn to the motivations and forms of the object of activity involved, it returns to concepts of flow and computational fluency present in CGD&P research.
