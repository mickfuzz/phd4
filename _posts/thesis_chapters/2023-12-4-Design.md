...
This table is supplemented with concise descriptions of the concepts [^5], and cross referenced with examples of the concepts in practice in common game features[^6]. 
