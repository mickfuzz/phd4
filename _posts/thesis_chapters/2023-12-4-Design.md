...
This section also explores how the features of a code playground align with aims of other specialist software designed to help novice coders (previously explored in LR). To recap these elements are steps to reducing syntax errors, shielding complexity, community sharing, supporting remixing.
...
The ability to easily remix community projects, supports the process of UMC. Specificaly, see inside in scratch. 
