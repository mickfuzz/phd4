...
In addition, for each code example I created descriptive step-by-step documentation which in P2 were developed into chapters of an online book [^12]. While prioritising an informal, hands-on approach over pre-teaching concepts, I struggled to resolve how best to provide background concepts and explanations of coding constructs. , a need which had arisen from parents in the feedback to P1 (see appendix 4.x).
