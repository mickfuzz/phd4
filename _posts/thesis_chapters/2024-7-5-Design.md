...
I encouraged personal expression for the purposes of engagement and motivation.

The freedom of choice and imagination allowed by designing on paper and via pixel art created compounding tensions. One crisis point involved a frustration of a child who was not able to implement a feature they wanted to add to the game next. A 3d bee design roaming a 3D landscape.  However, here it can lead to conflict and frustration as the desired changes of the child were not realistic to the technical scope of the project.

I also addressed participant expectations of an acceptable project scope for our timeframe as a non technical process.
<!--
