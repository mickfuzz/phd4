...
**patterns of use and trajectories of learning**
...
The findings of this chapter extend existing studies on use of GDPs, within educational context for young people. In Chapter two a rare study addressing [@eriksson_using_2019],  primarily focused on utility for researchers, positioning GDPs as a a common language between researchers to  structure analytical framing. The broad range focused on practice in this chapter extends this work significantly QUICK SUMMARY HOW?. In addition, in Chapter 7 broader conceptual contributions  in relation to abstract and concrete dimensions of knowledge and practice are developed.  
