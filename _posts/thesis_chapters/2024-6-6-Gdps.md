...
This form of interaction can be analysed using the professional framework called MDA. Mechanic is the jump  is ame mechanic, D is the ?, and A is the frustration experienced by fellow testers. Further parallels with MDA are explored later.
