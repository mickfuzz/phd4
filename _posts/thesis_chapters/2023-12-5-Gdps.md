...
It is thus potentially helpful to undertake a deeper analysis of the design patterns and specifically game design patterns at this point.  
...
MOVE TO METHODOLOGY? Blunden cites the process of identifying a germ cell of activity as a fruitful process for researchers [FIND]. In addition, Engestrom frames expansive learning as instructive for organisational change. While research is more sparse in the field of educational practice, the principles are frequently applied to classroom practice.

This chapter proposes the use of GDPs as a germ-cell and unit of analysis

While this concept of germ cell / unit of analysis a is more typically used in a larger scope of societal activity, the principles apply this smaller scope.

Mid-level construct of design / patterns heuristics []
NOTE - Explain that this  fits into the gap of research addressed in the introduction - the challenge of sharing practice and pedagogy beyond context.  
