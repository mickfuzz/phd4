...
GDPs emerged as a unit of analysis through their initial observation of GDPs as a germ-cell being used at different phases / scope of the learning design as it evolved.

Chapter four charted the evolution of the use of GDPs in the learning design from participant led brainstorming of desired features, to self-contained tutorials and code snippets. This then was enriched by wider framework from academia, professional community and and the work of educational Game Jams to form a themed framework of GDPs around, game mechanics, game space, game polish and game challenges.

The theoretical framework encourages discussion on the use of GDPs as a development tool to serve the advance game making community.
