...
It begins to explore the use of simple, high impact affordances which leverage home knowledge of gameplay concepts. While this chapter has a focus on design narrative, rather than impact, these aspects are explored in more depth in Chapter 6.

The change to a half-baked template had unintended consequences. Some positive, it  reduced the average working group size thus increasing the number of games being worked on as a whole and thus  helped issues of some being alienated from the group process if not working on the code changes, and also responded to the suggestion of introduction coding tools early to avoid the mismatch between participant planning and the technical limits of the coding possible at this novice level. Some were negative as he increased number of projects in play increased the demand on my time as a technical trouble shooter of code problems. The next section addresses this tension and other related to the introduction of supporting forms of documentation.  
