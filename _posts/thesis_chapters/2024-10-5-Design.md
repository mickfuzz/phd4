...
#### As part of the intro summary of the key features of this design narrative using the argumentative grammar of 3GAT / DBR
...
This can be expressed as revising toolsets to effective mediation practices by addressing emerging tensions, in an
