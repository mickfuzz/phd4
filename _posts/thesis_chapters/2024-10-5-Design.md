...
As part of the vignette dialogue, to help a participant access support to add a new feature to the game, I outline the two main sources of documentation : "Here’s the tutorial and there’s the examples of code". In the course of the vignette Toby chose to access only a code example of the desired game behaviour. He did not, as some in the group were doing in this session, use the tutorial which provided more descriptive, step-by-step guidance. Participants developed preferred approaches and tool choices especially in accessing help when adding a new feature to their game. Other participants relied only on direct verbal help from myself or other participants (like Toby) to help them progress.
...
As outlined above in P1 participants created a wish list of new features they wanted to add to each game. My attempts to support these requests in sessions without would involve my researching developer focused documentation and trying to adapt code examples from the phaser community. This process was time consuming and led to participant frustration, as I had limited time to work on each project. My response was to produced a variety of supporting documents and processes which were created and shared with participants in a responsive way via print outs and online google  work format documents.

This piecemeal approach to documentation, especially when combined with the disparate approach to graphical and audio asset creation, had resulted in an overly complex object.

In the development period (D1) between P1 and P2 I undertook extensive planning of both the starter template and documentation processes to try to simplify and scaffold the learner focused experience but retain the focus on learner choice. The tension between learner agency and clarity of instruction and support reoccurs consistently in my notes at this time.  By the beginning of P2 I had a prototype system to present the documentation in a consistent way. The following section details this process.
