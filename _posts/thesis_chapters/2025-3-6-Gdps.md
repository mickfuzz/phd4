...
### Addressing the use of GDPs in relation to theoretical understandings of processes of mediation and expanded objects of activity - I THINK THIS IS PROBABLY BEST SKIPPED OR VERY BRIEF HERE.
...
The uses of the quick-start activities, tutorials, and code snippets as supporting tools, if viewed in isolation, can be seen as a more straightforward, triangular form of subject, tool, and object mediation (see Chapter 4 diagram).

This chapter, along with the evolution of the learning design, exposed tensions where existing mediational strategies or tools were insufficient, and thus innovative forms of mediation were needed.

Elements of the innovation in the toolset of learning design, based on the emerging needs of the participants explored in this and the previous chapter, exemplify the development of new mediational strategies and tools.


At the larger scale, (see Fig.3.x) the games code and c can be seen as boundary objects for complex, and expanded interacting systems of activity.

In this research this exapanded object becomes increasingly complex.
...
NOW MAKE A LINK TO THE PROCESS OF THE NEXT CHAPTER.
