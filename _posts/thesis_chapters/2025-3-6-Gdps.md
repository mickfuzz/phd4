...
In Chapter 2 the value of a learning design using computational thinking patterns was explore through the concept of proximal flow. A synthesis of flow theory with socio-cultural concerns of learning context. The data of this chapter develops the scope of this line of research with more specific using framed using socio-cultural analysis and concepts.

Chapter 2 also explored fluency in varied forms, often tied to constructionist research, technological, digital and computation.
The guiding principle being self expression and identity formation.
...
Beyond fluidity, it is of value to explore explore other characteristics of the emerging design practices and potential strategies to support them. These include: a flexible approach to design stages, varied forms of incorporation of external repertoires, and a tension between choice of participant pathway and creative restrictions in the learning design.
