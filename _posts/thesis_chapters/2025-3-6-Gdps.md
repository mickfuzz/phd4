...
![Illustration 6.x - MDA as an additional framework promoting multiple means of engagement  ](./Pictures/ch_6_mda_dia_1.png){width=85%}
...
Given the complexity of the object being worked on in this research, and the disparate  sometimes chaotic nature of the emerging activity, [@biffi_chasing_2017-1; @de_freitas_classroom_2012; @cormier2008rhizomatic],  it is of value to return to existing research on CGD&Pn terms of goal formation and motivation in a way which invites discussion on how best to conceptualise the flexible design practices were present above data.
...
**Discussion on designing for fluency**
...
**Identifying characteristics of fluency**


In summative terms fluency can be seen in the mediational strategies outlined in this chapter in the following ways.
