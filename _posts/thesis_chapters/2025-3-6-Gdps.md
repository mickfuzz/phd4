...
Vignette 2 (V2.a) observes parent, indicated by (p), Susanna(p)'s use of a tutorial to address the goal of implementing her child's chosen GDPs. Susanna, who is limited in her programming skills but who avoiding seeking facilitator help (see V2.b), leverages the concept of GDPs, to independantly access written step-by-step instructions. Tehillah(c)'s choice over which GDPs they tackle has helped create a personal connection to the game, see Tehillah's positive reaction in the vignette above in her signing of the name of the key and door pattern.
...
INTEGRATE
Appendix.themeing outlines the evolution of how the sub-categories of patterns developed and the rationale guiding them in more detail.
