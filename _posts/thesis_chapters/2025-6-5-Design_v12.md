...
The shift in the object of activity, from playful design to more technical production, exposed a misalignment between participants' creative goals and the community norms forming around coding.

Addressing these tensions required rethinking not only the technical scaffolds but also the broader cultural framing of participation to accommodate the contributions involving visual design, sound production, and narrative development in an an on-going fashion.
