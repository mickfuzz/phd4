...
I postponed introducing code editing tools until around week five, prompted by concerns about overwhelming participants and my own ability to support unstructured coding from first principles. I 



When introduced, the code playground editor exposed learners to raw code, without the structural support provided by block-based interfaces.

This decision reflected my desire to support authentic engagement with real code [@chesterman_webmaking_2015].
