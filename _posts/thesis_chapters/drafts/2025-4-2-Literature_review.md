...
More specifically within a guiding ethos and overarching techniques, the
...
Margolis et al. \[@margolis_stuck_2008;\] outlined barriers contributing
...
Research on constructionism as an educational approach has increasingly
...
Computational Fluency, as a concept while not explicitly included in the
...
This section will broadly follow these streams. First, I will review
...
PBL requires learning environment and activities that allow for an
...
their fluency in movement between the levels as a form of self
...
In the work of Werner et al [-@werner2014using], game mechanics are seen
...
SGD is an extensive computing education program designed and delivered
...
Another important concept in the SGD pedagogy is that of student
...
The 5D approach also highlight important elements of the theoretical
...
This research locates particular potential in the use of is a socio
...
3.  How can varied dimensions of agency be identified and nurtured in an
...
In addition, maker culture more generally is relevant due to the
...
In addition, recent work on transformative agency within socio-cultural
...
Rogoff and Gutierrez's initial motivation in their exploration of
repertoires was to challenge simplistic, overgeneralising approaches
regarding learning styles especially if applied to non-dominant
communities [@gutierrez_cultural_2003]. The researchers highlight the
value of identifying potential funds of knowledge framed as "linguistic
and cultural-historical repertoires" that learners bring to learning
environments [@gutierrez_cultural_2003, p.22].

### Third spaces and the context of this study

The concept of third space is helpful in the context of this study in
particular as a space between home life and formal education rooted in a
sociocultural understandings of learning.
...
Teachers can also draw out attitudes and knowledge of game cultures and
...
My work on teach the web for Mozilla was motivated in part in the
...
In their brand style and selected picks of projects, many code
...
Writing in role or writing in action is a technique used in MoE
...
-   Hands on Education - what is it? Examples in STEM
...
The findings were mixed as while girls outperformed boys in use of
...
Project-approaches are widely advocated by Papert via constructionism
...
Specific techniques of PBL and digital making are explored in more depth
...
I propose that there guidance and tactics in area of discovery based
...
Research on project based learning using technology supports the
...
MOVE - chapter 2? COMPRESS? In Papert's research, detailed study of
young coders evolving code creations and accompanying interview data
allowed a close study of the personal appropriation, including elements
of understanding, application and sharing back this knowledge via
created and shared digital projects.
