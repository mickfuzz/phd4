...
-   [The Use of Gameplay Design Patterns "It's like a project in itself,
    ...
    -   [Cultural Dimension](#cultural-dimension)
        ...
        -   [GDP concepts and language used in informal feedback for
            ...
            community
            norms)](#gdp-concepts-and-language-used-in-informal-feedback-for-peers-to-influence-modification-of-games-developing-community-norms)
        -   [The propagation of use of GDPs - (through playtesting() IS
            IT PLAYTESTING THAT IS IMPORTANT HERE - OR THE ROLE AND
            NATURE OF GDPS TO AID
            PROPAGATION](#the-propagation-of-use-of-gdps---through-playtesting-is-it-playtesting-that-is-important-here---or-the-role-and-nature-of-gdps-to-aid-propagation)
...
These varied forms of documentation, and their varied adoption and propagation
represent different  approaches to  scaffolding  the process of becoming familiar with and then modifying to the code in often increasingly ambitious ways inline with the stages and ethos of a use-modify-create (UMC) approach. [source]
