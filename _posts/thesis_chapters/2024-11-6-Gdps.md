...
This chapter develops analysis of GDPs used in diverse meditational strategies not only as part of facilitator-provided resources and scaffolds but as part of emerging community practices and interpersonal repertoires.

During data analysis, these uses of GDPs emerged as so important in varied forms that they became a candidate for a germ cell concepts. The following sections explore the variety of uses.

A final section of this chapter analysis how this proposition of GDP as germ cell fits within a CHAT analysis.   


_Structure of the chapter around 3 planes / activity system scopes_


To present findings from video data, I draw on the Rogoff's three planes of analysis [@rogoff_observing_1995] as explored in Chapter 4. Acknowledging that these observation do not fall nearly into each of the three planes, I cover observation on the use of GDPs relating to, in turn, cultural activities, interpersonal activity and finally personal knowledge.

The sections focus on analysis of use of design patterns are used by parents, children and facilitators at using the three different foci. There is an broad analogue between
analysis using these three planes and analysis of activity systems at larger or smaller scopes.
Explicitly the cultural plane can be compared to the community scope of activity described in the previous chapter in Figure 5.x and interpersonal and personal planes with the smaller scope in Figure 5.x
