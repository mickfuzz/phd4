...
In the last chapter I outlined the evolution of tool use focusing on emerging tensions in activity. This chapter increases focus on participant perspective, using recorded data to make an interpretation of the varied uses of gameplay design patterns (GDPs) and in doing so addresses the research question - _how can game design patterns support the development of coding practices by novices_?


<!-- Guided by Rogoff's concept of guided participation, this chapter analyses this emergent activity at a scope between concrete tool use and the wider cultural context of the game making community.  -->

_Recap on design patterns and game design patterns_

In chapter two the use of design patterns in an education context were summarised. While existing research on the use of game design patterns in educational settings exists, specifically, to aid transfer of science simulation concepts to other settings [@repenning_scalable_2015; @basawapatna_using_2010] and to provide a useful basis for co-design work  [@eriksson_using_2019], little exists which addresses their use to overcome challenges in participation in an emerging community of game making using text coding.  
...
The last chapter explored the activity of iteratively of altering a game at the level of gameplay design pattern as one part of the mutual evolution of the learning design in varied forms including;  supporting resources, in the form of a set of code examples, instruction tutorials, quick start activities which proposed micro level code modification.
AND?  provided support processes.
...
This chapter develops analysis of GDPs used in diverse meditational strategies not only as part of facilitator-provided resources and scaffolds but as part of emerging community practices and interpersonal repertoires. During data analysis, these uses of GDPs emerged as so important in varied forms that they became a candidate for a germ cell concepts.
...
To analyse and present findings from recorded data, I have draw on Rogoff's three planes of analysis [@rogoff_observing_1995] as explored in Chapter 4. Acknowledging that these observation do not fall nearly into each of the three planes, I cover observation on the use of GDPs relating to, in turn, cultural activities, interpersonal activity and finally personal knowledge.

The sections focus on analysis of use of design patterns are used by parents, children and facilitators at using the three different foci. There is an analogy between analysis using these three planes and analysis of activity systems at larger or smaller scopes. More explicitly, the cultural plane can be compared to the community scope of activity described in the previous chapter in Figure 5.x and interpersonal and personal planes with the smaller scope in Figure 5.x
...
The child Olivia also wants to add additional levels to their game. In recent sessions several young participants had added new levels to their games, including Toby who added over twenty. This activity had sparked much discourse between participants which may have influence Olivia's interest.
...
REFERENCE THE FOLLOWING IN AN APPENDIX
<!-- Later Olivia interacts with one of the student helpers and outlines her motivations in design.
