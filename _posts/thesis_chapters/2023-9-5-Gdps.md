...
## Chapter introduction and place in the thesis
...
In the last chapter we explored inclusive pedagogical methods that helped participants become part of an emerging community of game makers.

This chapter analyses a sub-activity system to the creation of the whole game, namely the implementation of individual game design patterns (GDPs).


### Chapter outline

This chapter begins with reframing of game design patterns and game play design patterns which builds on the previous chapters description of the emerging learning design.

Following this a Vignette of parent child interaction in game making process. The vignette is used to introduce an overview of interactions of that pair generated from analysis of video data.

I draw on detailed observations of participants in practice to outline how GDPs are used by participants.
...
## Re-examing design patterns in this context

Recap on the value of design patterns in learning design which exist at different scopes of activity [@mcandrew_patterns_2006].
...
Both concepts are similar but different focus.

    Thus the germ-cell and the unit of analysis are one and the same thing, but in one case the developmental aspect is emphasised and in the other case the analytical aspect is emphasised. [@blunden_unit_2020]


As a designer / researcher and practitioner both aspects are relevant.

#### On GDPs as a germ concept to help development

The theoretical framework invites discussion on what is the germ cell of the overall game making activity.

While this concept is more typically used in a larger scope of societal activity, the principles apply this smaller scope. The core concept of altering a game at the level of gameplay design pattern which emerged from experimental pilot process is adapted by participants and used in various forms of activity.

Blunden cites the process of identifying a germ cell of activity as a fruitful process for researchers [FIND]. In addition, Engestrom frames expansive learning as instructive for organisational change. While research is more sparse in the field of educational practice, the s
...
COMPRESS THIS OR DROP OR MOVE? - IT DOESN'T ADD A GREAT DEAL TO THE END FINDINGS?
...
Analysing the implementation of GDPs as a unit of activity allows the use of useful concepts to explore the specifics of participant behaviour. In the methodology and design chapter I explored the concept of resolving tensions involved in tool use and interaction with the learning design.

MOVE FROM LAST CHAPTER

**Building familiarity with game structure**
...
While the process of games analysis has limited research for novice game makers, there is related research in the field of learning text coding. FIND?
