...
## Reframing design pattern in this context
...
### On GDP as a Germ cell / rising to the concrete

The theoretical framework invites discussion on what is the germ cell of the overall game making activity. While this concept is more typically used in a larger scope of societal activity I invite discussion on how it applies at this smaller scope.  I propose that it is the  implementation of game features design pattern that forms the germ cell of this game making activity.

The smaller changes described in the last chapter constitute a formative, scaffolding process to help participants prepare for the foundational activity of deciding on and implementing gameplay design patterns.
