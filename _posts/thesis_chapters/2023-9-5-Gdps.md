...
#### Analysis against (and calls to heed) existing design heuristics - AS THIS ADDRESSES GDP TOO THIS WAS MOVED  TO GDP CHAPTER (OR TO DISCUSSION CHAPTER OR DESIGN)

Earlier (cr), we examined of challenges of the authenticity of the authentic tools set consisting of js, phaser, html, and a code-playround.
