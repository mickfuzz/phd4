...
<!-- move this part on possibilities to personal perspective / quick benefits of projects section -->
...
<!-- ## Coding well is well hard

At this point I want to focus on coding as a particular subset of computing and make the point that it is really hard to learn. I also want to follow that by saying it\'s even harder to teach. There is a lot you need to get right , lots that can go wrong, really specific support is needed and a lot of persistence. Choosing suitable coding projects for novices is hard to get right. They may be too hard or too boring.

Also good Code is hard to read. What I mean by that is when it comes to a modern object oriented approach to coding, this can make the code less easy to read through and predict what it can do. -->
