...
The book chapter was based on observations of the pedagogy that emerged with much less of a focus on more detailed analysis of data. As such the focus is on tips for practitioners. It is useful at this point to outline the updated research questions which emerged from a closer analysis of the the collected data.  
...
#### Identifying tensions and motivations
...
To allow for a greater depth of analysis I opted to anaylse key game making sessions in greater detail rather than all ten in a more summative fashion.  

In the last review I outlined that I am exploring alternatives to coding video data in the Nvivo software package due to its limitations in playing and reviewing video data and the large amount of video data I am dealing with . I have adopted a process for coding and describing section
...
I initially drew on on design stages, modes of interaction do guide coding. The coding structure is still being revised as I continue to analyse data.
...
Table of summary of use of GDPs.
