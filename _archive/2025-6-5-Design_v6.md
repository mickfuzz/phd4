...
<!--
### Contradiction 1: mediation through tools and technical scaffolds

This first contradiction area focuses on tool use, facilitation, and mediation. It is developed across three recurring tensions observed during P1: (1) learner ambition versus tool complexity, (2) facilitator support limits, and (3) the lack of accessible documentation or reference materials. Together, these reveal systemic contradictions in how the object of activity was pursued and supported.

#### T1 – Learner ambition vs tool complexity

As a recap from Chapter 4, P1 was exploratory, while P2 marked the first full phase using introduced resources. In this section, I draw on journal notes and participant feedback to describe emerging tensions in kickstarting participant game design activity and the subsequent evolution in tool use between P1 and P2.

My initial focus in the early stages of P1 was to create a welcoming, low-pressure environment for introducing and exploring the process of making games. To achieve this, I used several activities unrelated to computer coding to scaffold the game design process. Early sessions included playing and discussing retro arcade games, analysing their components, brainstorming game story scenarios, creating pixel-art characters on paper, and making craft collages representing game levels.

However, when participants eventually began working with the programming tool, I noticed that several learners had ambitious game ideas that could not easily be realised using the starter code provided. These ambitions included scoring systems, cut scenes, complex enemy behaviours, and narrative elements. Learners expressed frustration at the gap between their imagined game and what could realistically be implemented. This surfaced a clear tension between learner ambition and the constraints of the programming environment, particularly the difficulty of navigating and editing JavaScript code in the browser interface.

#### T2 – Facilitator support limits

Another recurring issue was the demand placed on me as facilitator. Many participants needed one-to-one guidance with core programming concepts, even to make small changes to their projects. While some learners made progress through trial and error or by copying working code, others became blocked early and disengaged. My efforts to lead whole-group walkthroughs were largely unsuccessful, as learners worked at different speeds or became distracted during collective instruction. This created a contradiction between the division of labour (solo facilitation) and the object of enabling creative coding at scale.

These challenges were reflected in my research journal and fieldnotes, where I repeatedly commented on my own fatigue and the difficulty of sustaining meaningful technical support across the group. Peer support structures had not yet stabilised, and learner motivation was fragile.

#### T3 – Gaps in documentation and visible pathways

The lack of reference materials also contributed to recurring confusion. Several learners asked the same questions multiple times over successive sessions, and there was no shared or visible resource they could consult for support. I had not yet developed or circulated consistent documentation to support the starter code or expected programming patterns.

This reflected a contradiction between the rules/tools of the activity system and the object of independent creative coding. Learners lacked a mediating artefact to guide action and review progress. As a result, they frequently became stuck on syntax, variable names, or structural elements of the code.

#### Design response

In response to these combined tensions, the learning design was adapted between P1 and P2. A new starter game template was introduced, featuring editable parameters, simple animation loops, and space for personalisation. I also began prototyping visual documentation, including asset sheets, pixel-art guides, and short walkthrough videos. These moves were designed to reduce dependence on real-time facilitation and to support experimentation through familiar, modifiable code blocks.

#### Observed impact

These adaptations led to a noticeable shift in learner engagement and autonomy in P2. Participants were more likely to test changes, remix visual elements, and build from the starter code rather than abandoning ideas. While some contradictions remained (particularly around pacing and fluency), the learning environment stabilised, and facilitator demands became more manageable. This period also saw the early development of gameplay design patterns (GDPs), discussed later in this chapter and in more depth in Chapter 6. -->
